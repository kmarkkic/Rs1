...
namespace Market.Infrastructure.Migrations
{
    ...
    [Migration("20260604162314_AddNotificationsReviewsHealthRecordsMessages")]
    partial class AddNotificationsReviewsHealthRecordsMessages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Market.Domain.Entities.UdomiMe.AnimalHealthRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Market.Domain.Entities.UdomiMe.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Market.Domain.Entities.UdomiMe.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Market.Domain.Entities.UdomiMe.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Market.Domain.Entities.UdomiMe.Message", b =>
                {
                    b.HasOne("Market.Domain.Entities.Identity.MarketUserEntity", "Receiver")
                        .WithMany("ReceivedMessages")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Market.Domain.Entities.Identity.MarketUserEntity", "Sender")
